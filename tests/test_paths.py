...
class BuildDocumentPathsTests(unittest.TestCase):
    def test_document_paths_are_grouped_under_doc_id(self):
        ...
        self.assertEqual(paths.readme, Path("manuals/processed/docling_bundle/stm32f4-rm0090/README.generated.md"))
        self.assertEqual(paths.quality_summary, Path("manuals/processed/docling_bundle/stm32f4-rm0090/quality-summary.md"))
        ...
        self.assertEqual(paths.pages_dir, Path("manuals/processed/docling_bundle/stm32f4-rm0090/pages"))
        self.assertEqual(paths.tables_dir, Path("manuals/processed/docling_bundle/stm32f4-rm0090/tables"))
        self.assertEqual(paths.runtime_dir, Path("manuals/processed/docling_bundle/stm32f4-rm0090/runtime"))
        self.assertEqual(paths.windows_dir, Path("manuals/processed/docling_bundle/stm32f4-rm0090/runtime/cache"))
