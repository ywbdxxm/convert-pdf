...
def build_readme(
    ...
    lines = [
        ...
        "2. Use `sections.jsonl` for topic navigation.",
        "3. Use `chunks.jsonl` for page-aware retrieval.",
        "4. Use `tables.index.jsonl` and `tables/` for structured table verification.",
